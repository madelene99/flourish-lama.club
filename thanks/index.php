...
<form action="https://docs.google.com/forms/d/e/1FAIpQLScnSrcwH09EtCUIajtWQfvA8RB-vGb5F5ofhwQmvKJvun4nqA/formResponse" method="POST">
...
<script>
  $(document).ready(function() {
    ...
    window.history.pushState(null, null, "https://flourish-lama.club/thanks/");
...
function good(){
     ...
     $.ajax({
        url:     "https://docs.google.com/forms/d/e/1FAIpQLScnSrcwH09EtCUIajtWQfvA8RB-vGb5F5ofhwQmvKJvun4nqA/formResponse",  
        type:     "GET",  
        dataType: "html",  
        data: $("form").serialize(),  
        success: function(response) {  
